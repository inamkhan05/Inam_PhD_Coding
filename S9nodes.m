...
xl=[1.2,0.6,2,4.5,5.5,6,9.5,8.2,7];     % x coordinate values
yl=[1.5,4.5,8.5,1.2,3.5,9,0.8,6,8];     % y coordinate values
zl=[3.5,7.5,8.4,5.5,7.7,4,6.7,4.6,6.2]; % z coordinate values
mobileLoc  = [5,5,5];  % unknown node
